"""
Backside Pop Scanner V11 Enhanced - B-Grade Setups with Analysis Columns
V11 Enhanced Features:
...
- Enhanced with all new analysis parameters for optimization research
"""
...
class BacksidePopScannerV11Enhanced:
    ...
    def __init__(self, polygon_api_key=None):
        ...
        # V11 More relaxed scan thresholds for B-grade setups - UNCHANGED
        ...
        # V10 Original strict thresholds for filtering out A+ setups - UNCHANGED
    ...
    def calculate_setup_grade(self, metrics):
        """Calculate setup grade based on key metrics - B-grade adjusted"""
        # Grade based on trend strength, extension, and fade quality
        grade = 0
        
        # Trend ATR component (0-30 points) - more lenient for B-grade
        ...
        # Extension ATR component (0-25 points) - more lenient
        ...
        # Fade ATR component (0-25 points) - more lenient
        ...
        # Volume multiple component (0-20 points) - more lenient
    ...
    def calculate_fade_grade(self, fade_info, metrics):
        """Calculate fade grade based on fade pattern quality - B-grade adjusted"""
        grade = 0
        
        # Red days component (0-40 points) - more lenient
        ...
        # Outlier fade component (0-30 points) - more lenient
        ...
        # Fade ATR component (0-30 points) - more lenient
        fade_atr = metrics.get('fade_atr', 0)
        if fade_atr >= 4:
            grade += 30
        elif fade_atr >= 3:
    ...
    def would_qualify_for_v10(self, df, idx, euphoric_high, trend_start_price, euphoric_date):
        """Check if this setup would also qualify for V10 (A+ criteria) - UNCHANGED"""
        prev_idx = idx - 1
    ...
    def analyze_fade_pattern_v10(self, df, setup_idx, euphoric_high):
        """V10 fade pattern analysis (stricter) - UNCHANGED"""
    ...
    def analyze_fade_pattern(self, df, setup_idx, euphoric_high):
        """V11: Analyze fade pattern with relaxed criteria - UNCHANGED"""
    ...
    def find_trend_and_euphoric_high_fast(self, df, setup_idx):
        """Optimized trend and euphoric high detection - UNCHANGED"""
        if setup_idx < 20:
    ...
    def scan_single_ticker_v11_enhanced(self, symbol, start_date, end_date):
        """V11 Enhanced B-Grade scan with additional analysis columns - SCAN CRITERIA UNCHANGED"""
        ...
        for idx in range(1, len(df)):
            ...
            # V11 RELAXED FILTERS FOR B-GRADE - UNCHANGED
            ...
            # Check fade pattern (relaxed) - UNCHANGED
            ...
            # CRITICAL: Exclude setups that would qualify for V10 (A+ setups) - UNCHANGED
            ...
            # V11 Relaxed scan criteria for B-grade setups - UNCHANGED
            scan_criteria = all([
            ...
            if scan_criteria:
                ...
                # 6. Setup and Fade Grades (B-grade adjusted)
                setup_metrics = {
                ...
                setup = {
                    ...
                    # Original V11 metrics (core ones)
                    ...
                    'd_minus_1_avg_dollar_vol_20d': round(d_minus_1_dollar_vol_20d / 1_000_000, 1),
                    'scanner_version': 'V11_Enhanced',
                    'setup_grade_type': 'B'
                }
                setups.append(setup)
    ...
    def run_scan_v11_enhanced(self, start_date=None, end_date=None, tickers=None):
        """V11 Enhanced B-Grade scanner with additional analysis columns"""
        start_date = start_date or START_DATE
        end_date = end_date or END_DATE
        tickers = tickers or self.ticker_universe
        
        print(f"🚀 BACKSIDE POP SCANNER V11 ENHANCED - B-GRADE ANALYSIS COLUMNS")
        print(f"📅 Scanning {len(tickers)} tickers from {start_date} to {end_date}")
        print(f"🔧 V11 Enhanced Features:")
        print(f"   • SCAN CRITERIA UNCHANGED - same B-grade setups as V11")
        print(f"   • Excludes any setup that would qualify for V10 (A+ criteria)")
        print(f"   • Added B-grade adjusted setup_grade and fade_grade calculations")
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            future_to_ticker = {
                executor.submit(self.scan_single_ticker_v11_enhanced, ticker, start_date, end_date): ticker 
        ...
        print("\n" + "=" * 80)
        print(f"🎯 V11 ENHANCED B-GRADE SCAN COMPLETE")
        ...
        if all_setups:
            ...
            print(f"\n🏆 TOP ENHANCED B-GRADE SETUPS BY GRADE:")
            ...
            # Enhanced B-grade statistics
            print(f"\n📊 ENHANCED B-GRADE ANALYSIS BREAKDOWN:")
            ...
            # B-grade specific analysis
            print(f"\n📊 B-GRADE SPECIFIC METRICS:")
            print(f"   Avg Dollar Volume (20d): ${df_results['d_minus_1_avg_dollar_vol_20d'].mean():.1f}M")
            print(f"   Avg Trend ATR: {df_results['trend_atr'].mean():.2f}")
            print(f"   Avg Extension ATR: {df_results['extension_atr'].mean():.2f}")
            print(f"   Avg Fade ATR: {df_results['fade_atr'].mean():.2f}")
...
if __name__ == "__main__":
    # Initialize V11 Enhanced B-Grade scanner
    scanner = BacksidePopScannerV11Enhanced()
    
    # Run V11 enhanced scan with analysis columns
    results = scanner.run_scan_v11_enhanced()
    
    if not results.empty:
        # Save enhanced results to CSV
        results.to_csv('backside_pop_v11_enhanced_b_grade_results.csv', index=False)
        print(f"\n💾 Enhanced B-grade results saved to: backside_pop_v11_enhanced_b_grade_results.csv")
        
        # Display all columns for analysis
        print(f"\n📋 ALL B-GRADE ANALYSIS COLUMNS:")
